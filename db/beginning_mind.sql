...
-- ----------------------------
-- Table structure for security_users2permissions
-- ----------------------------
DROP TABLE IF EXISTS `security_users2permissions`;
CREATE TABLE `security_users2permissions` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `inserted_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '审计字段 插入时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '审计字段 更新时间',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '审计字段 是否被删除',
...
-- ----------------------------
-- Records of security_users2permissions
-- ----------------------------
INSERT INTO `security_users2permissions` VALUES ('1', '2018-05-26 17:10:33', '2018-05-26 17:11:08', '0', '1', '257');
