...
entity_template = Template('''package {{base_package_reference}}.entity;
...
mapper_java_template = Template('''
package {{base_package_reference}}.mapper;

import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import {{base_package_reference}}.entity.{{entity_name}}Entity;
...
mapper_xml_template = Template('''
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE mapper PUBLIC "-//mybatis.org//DTD Mapper 3.0//EN" "http://mybatis.org/dtd/mybatis-3-mapper.dtd">
<mapper namespace="{{base_package_reference}}.mapper.{{entity_name}}Mapper">
</mapper>''')

repo_template = Template('''
''')

repo_impl_template = Template('''
''')
