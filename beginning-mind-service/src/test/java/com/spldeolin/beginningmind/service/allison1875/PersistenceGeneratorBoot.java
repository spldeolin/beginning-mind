...
import com.spldeolin.beginningmind.service.allison1875.serviceimpl.persistencegenerator.CommentServiceImpl2;
import com.spldeolin.beginningmind.service.allison1875.serviceimpl.persistencegenerator.JdbcTypeServiceImpl2;
    ...
    public static void main(String[] args) {
        ...
        Allison1875.allison1875(Application.class, new PersistenceGeneratorModule(config) {
            ...
            protected void configure() {
                super.configure();
                bind(JdbcTypeService.class).toInstance(new JdbcTypeServiceImpl2(Constant.BASE_PACKAGE + ".enums"));
