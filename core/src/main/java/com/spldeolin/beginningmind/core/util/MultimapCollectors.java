...
public class MultimapCollectors<T, K, V> implements Collector<T, Multimap<K, V>, Multimap<K, V>> {
    ...
    public static <T, K, V> MultimapCollectors<T, K, V> toMultimap(Function<T, K> keyGetter,
        ...
        return new MultimapCollectors<>(keyGetter, valueGetter);
    }

    public static <T, K> MultimapCollectors<T, K, T> toMultimap(Function<T, K> keyGetter) {
        return new MultimapCollectors<>(keyGetter, v -> v);
    }
